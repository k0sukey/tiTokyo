(function(a) {
    ...
    function I(a) {
        ...
        this._milliseconds = j + i * 1000 + h * 60000 + g * 3600000, this._days = f + e * 7, this._months = d + c * 12, b.milliseconds = j % 1000, i += J(j / 1000), b.seconds = i % 60, h += J(i / 60), b.minutes = h % 60, g += J(h / 60), b.hours = g % 24, f += J(g / 24), f += e * 7, b.days = f % 30, d += J(f / 30), b.months = d % 12, c += J(d / 12), b.years = c, this._lang = !1;
    }
    function J(a) {
    ...
    function P(a, c) {
        ...
        for (d = 0; d < 12; d++) e = b([ 2000, d ]), g[d] = new RegExp("^" + (c.months[d] || c.months(e, "")) + "|^" + (c.monthsShort[d] || c.monthsShort(e, "")).replace(".", ""), "i");
    ...
    function $(a, b, c) {
        var e = d(Math.abs(a) / 1000), f = d(e / 60), g = d(f / 60), h = d(g / 24), i = d(h / 365), j = e < 45 && [ "s", e ] || f === 1 && [ "m" ] || f < 45 && [ "mm", f ] || g === 1 && [ "h" ] || g < 22 && [ "hh", g ] || h === 1 && [ "d" ] || h <= 25 && [ "dd", h ] || h <= 45 && [ "M" ] || h < 345 && [ "MM", d(h / 30) ] || i === 1 && [ "y" ] || [ "yy", i ];
    ...
    D.DDDD = F(D.DDD, 3), b = function(c, d) {
        ...
        diff: function(a, c, e) {
            var f = this._isUTC ? b(a).utc() : b(a).local(), g = (this.zone() - f.zone()) * 60000, h = this._d - f._d - g, i = this.year() - f.year(), j = this.month() - f.month(), k = this.date() - f.date(), l;
            return c === "months" ? l = i * 12 + j + k / 30 : c === "years" ? l = i + (j + k / 30) / 12 : l = c === "seconds" ? h / 1000 : c === "minutes" ? h / 60000 : c === "hours" ? h / 3600000 : c === "days" ? h / 86400000 : c === "weeks" ? h / 604800000 : h, e ? l : d(l);
        },
        from: function(a, c) {
    ...
    bb("Weeks", 604800000), h && (module.exports = b), typeof ender == "undefined" && (this.moment = b), typeof define == "function" && define.amd && define("moment", [], function() {
        return b;
    });
}).call(this);